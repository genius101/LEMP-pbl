...
- [x]	Your new website is now active, but the web root /var/www/projectLEMP is still empty. 
- [x]	Create an index.html file in that location so that we can test that your new server block works as expected:
